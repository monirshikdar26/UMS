...
<div class="wrapper">
  ...
  <aside class="control-sidebar">
	...
	<div class="rpanel-title"><span class="pull-right btn btn-circle btn-danger"><i class="text-white ion ion-close" data-toggle="control-sidebar"></i></span> </div>  <!-- Create the tabs -->
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="control-sidebar-home-tab">
          ...
          <div class="mt-20 media-list media-list-hover">
			<div class="px-0 py-10 media">
...
<!-- ./wrapper -->
	...
	<script src="{{ asset('ssets/vendor_components/easypiechart/dist/jquery.easypiechart.js') }}a"></script>
